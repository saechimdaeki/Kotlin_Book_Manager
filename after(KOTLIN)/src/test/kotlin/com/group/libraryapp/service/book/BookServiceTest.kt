...
class BookServiceTest @Autowired constructor(
    ...
    fun loanBookTest() {
        ...
        val savedUser = userRepository.save(User("김준성", null))
        val request = BookLoanRequest("김준성","이상한 나라의 앨리스")
        //when
    ...
    fun returnBookTest(){
        ...
        val savedUser = userRepository.save(User("김준성", null))
        userLoanHistoryRepository.save(UserLoanHistory.fixture(savedUser,"이상한 나라의 앨리스"))
        val request = BookReturnRequest("김준성","이상한 나라의 앨리스")
    ...
    fun countLoanedBookTest(){
        ...
        //given
        val savedUser = userRepository.save(User("saechim", null))
